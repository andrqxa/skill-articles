...
//                // if search invoke listener for focus
...
class MultiLineRender(
    ...
    override fun draw(
        ...
        // draw first line - скруглена слева
        ...
        //draw middle line - без скруглений
        ...
        // draw last line - скруглена справа
        ...
        drawStart(canvas, lineStartOffset, lineTop, endOffset + padding, lineBottom)
    }
